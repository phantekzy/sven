...
const Sidebar = () => {
  ...
  // Calculate combined total for the badge
        ...
        <div className="flex items-center gap-3 px-2">
          <div className="avatar">
            <div className="size-10 rounded-full ring-1 ring-base-300 ring-offset-base-100 ring-offset-2">
              <div dangerouslySetInnerHTML={{ __html: authUser?.profilePic }} />
            </div>
          </div>
          <div className="flex-1 min-w-0">
            <p className="font-semibold text-base-content text-sm truncate">{authUser?.fullName}</p>
