...
const SignUpPage = () => {
  ...
  const inputStyles = "w-full px-5 py-4 bg-base-200/50 border-4 border-base-200 rounded-2xl font-bold focus:border-primary focus:bg-base-100 focus:outline-none transition-all placeholder:opacity-30";
        ...
        <div className="w-full lg:w-1/2 p-8 sm:p-12 md:p-16 flex flex-col justify-center bg-base-100 relative pt-12">
          ...
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            <div className="pt-4">
              ...
              >
                <div className="absolute inset-0 bg-primary-focus rounded-2xl translate-y-2 group-active:translate-y-0 transition-all shadow-[0_4px_15px_rgba(88,204,2,0.4)]" />
